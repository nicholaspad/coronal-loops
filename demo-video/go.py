...
def hmialign(data, scale):
	...
	x_center = 4096 - int(AIA304.reference_pixel.y.value + 0.5)
	y_center = 4096 - int(AIA304.reference_pixel.x.value + 0.5)
...
RECORDER.sys_text("**** VFRAMES %d" % (ID - p))
p = copy(ID)
