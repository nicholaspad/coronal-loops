...
print Color.YELLOW + "\nGENERATING VIDEO...\n" + Color.RESET
os.system("ffmpeg -y -f image2 -start_number 000 -framerate %s -i %s/resources/region-detection-images/detected-%%3d.jpg -q:v 2 -vcodec mpeg4 -b:v 800k \"%s/videos/%s.mp4\"" % (args.framerate, main_dir, main_dir, video_name))
