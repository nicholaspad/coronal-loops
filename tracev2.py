...
def getnewfov(img, dir, xi, yi):
	if dir=="xup":
		...
		_fov = img[yi-fov_rad:yi+1, xi-fov_rad:xi+1]

	elif dir=="downleft":
		_fov = img[yi:yi+fov_rad+1, xi-fov_rad:xi+1]

	elif dir=="upright":
		_fov = img[yi-fov_rad:yi+1, xi:xi+fov_rad+1]

	elif dir=="downright":
		_fov = img[yi:yi+fov_rad+1, xi:xi+fov_rad+1]
