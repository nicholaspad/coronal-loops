...
for hour in range(0, hours):
	...
	hv.download_jp2("2016/04/17 %02d:00:00" % (hr), observatory = "SDO", instrument = "HMI", detector = "HMI", measurement = "continuum")
	print "%.0f percent complete." % (100.0 * (hour + 1)/float(hours))

folder = '/Users/LMSAL/sunpy/data'
name = 'output.mp4'

images = [img for img in os.listdir(folder) if img.endswith(".jp2")]
